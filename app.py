...
def get_settings():
    ...
    if not settings:
        settings = {
            ...
            "admin_password": hashlib.sha256("sakil2026".encode()).hexdigest()
        }
...
# ============================================
# PREMIUM LOGIN PAGE - CYBERPUNK EDITION (FIXED COLORS)
# ============================================
LOGIN_HTML = '''
<!DOCTYPE html>
<html lang="en">
        ...
        * { margin: 0; padding: 0; box-sizing: border-box; }
        ...
        .login-container {
            ...
            box-shadow: 
                ...
                inset 0 0 80px rgba(0, 255, 255, 0.005);
...
# ============================================
# REGISTER PAGE - CYBERPUNK EDITION (FIXED COLORS)
# ============================================
REGISTER_HTML = '''
<!DOCTYPE html>
<html lang="en">
...
# ============================================
# MAIN DASHBOARD - CYBERPUNK EDITION (FIXED COLORS)
# ============================================
USER_PANEL_HTML = '''
<!DOCTYPE html>
<html lang="en">
...
# ============================================
# ADMIN DASHBOARD HTML (FIXED COLORS)
# ============================================
